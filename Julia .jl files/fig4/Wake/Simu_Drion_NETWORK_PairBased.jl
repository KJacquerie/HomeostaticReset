...
# Include model
include("Drion_NETWORK_PairBased.jl")
...
possible_freq =  [0.1, 1, 5, 10, 15, 20, 25, 30]#, 35, 40, 45, 50]#, 35, 40, 45, 50, 55, 60]
neurons_freq = rand(possible_freq, ncells)# Neurons spiking frequencies in Hz
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBig_Wake/Results_PairBased/neurons_freq.dat", neurons_freq, header = false)
#neurons_freq = readdlm("/Users/kathleen/Documents/PhD/2022-reset/NetBig_wake/Results/neurons_freq.dat")
spike_duration = 3 # spike duration in ms
Iapp_true = get_Iapp(T, dt, neurons_freq, spike_duration)
Iapp_true[end,:] = 3*ones(convert(Int64, T/dt))



const IappE = 0.
const IstepE = 0.
const tstepEinit = T # Burst moment
const tstepEfinal = T
...
#writedlm("Results/gAMPA.dat", gAMPA, header = false)
...
#writedlm("Results/w_mat.dat", w_mat, header = false)
...
@time (Vconnect, w_) = simulateTOY_ncells(ncells,nPrecells,nPostcells,IappE,IappI,tstepEinit,tstepEfinal,IstepE,tstepIinit1,tstepIinit2,tstepIinit3,tstepIinit4,tstepIfinal,IstepI1,IstepI2,IstepI3,IstepI4,gAMPA, gGABAA_vec, gGABAB_vec, w_mat, Iapp_true)
...
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/SPB_depol1.dat", SPB_depol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/SPB_hyperpol1.dat", SPB_hyperpol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/PER_depol1.dat", PER_depol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/PER_hyperpol1.dat", PER_hyperpol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/DC_depol1.dat", DC_depol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/DC_hyperpol1.dat", DC_hyperpol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/IBF_depol1.dat", IBF_depol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/IBF_hyperpol1.dat", IBF_hyperpol1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/freq_depol1.dat", freq_depol_vec1, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/freq_hyperpol1.dat", freq_hyperpol_vec1, header = false)


writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/Vconnect_spk.dat", Vconnect, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/w.dat", w_, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/gCaTvec_E.dat", gCaTvec_E, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/gCaTvec_C.dat", gCaTvec_C, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results_PairBased/gCaTvec_I.dat", gCaTvec_I, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/pot_mat.dat", pot_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/dep_mat.dat", dep_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/nul_mat.dat", nul_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/tot.dat", tot, header = false)
