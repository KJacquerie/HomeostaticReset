...
# Simulations
const nPrecells = 10 # Number of excitatory cells
const nIcells = 1 # Number of inhibitory cells
const nPostcells = 10 # Number of excitatory cells
...
possible_freq =  [0.1, 1, 5, 10, 15, 20, 25, 30]#, 35, 40, 45, 50, 55, 60]
#neurons_freq = rand(possible_freq, ncells)# Neurons spiking frequencies in Hz
#writedlm("Results/neurons_freq.dat", neurons_freq, header = false)
neurons_freq = readdlm("Results/neurons_freq.dat")
...
w_mat = readdlm("Results/w_mat.dat")
...
@time (Vconnect, w_, pot_mat, dep_mat, nul_mat, tot) = simulateTOY_ncells(ncells,nPrecells,nPostcells,IappE,IappI,tstepEinit,tstepEfinal,IstepE,tstepIinit1,tstepIinit2,tstepIinit3,tstepIinit4,tstepIfinal,IstepI1,IstepI2,IstepI3,IstepI4,gAMPA, gGABAA_vec, gGABAB_vec, w_mat, Iapp_true)
...
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/Vconnect_spk.dat", Vconnect, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/w.dat", w_, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/gCaTvec_E.dat", gCaTvec_E, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/gCaTvec_C.dat", gCaTvec_C, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG_wake/Results/gCaTvec_I.dat", gCaTvec_I, header = false)
