...
const gAMPA = readdlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results/gAMPA.dat")
...
const w_mat = readdlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results/w_mat.dat")
...
@time (Vconnect, w_) = simulateTOY_ncells(ncells,nPrecells,nPostcells,IappE,IappI,tstepEinit,tstepEfinal,IstepE,tstepIinit1,tstepIinit2,tstepIinit3,tstepIinit4,tstepIfinal,IstepI1,IstepI2,IstepI3,IstepI4,gAMPA, gGABAA_vec, gGABAB_vec, w_mat)
...
writedlm("Results_PairBased/SPB_depol1.dat", SPB_depol1, header = false)
writedlm("Results_PairBased/SPB_hyperpol1.dat", SPB_hyperpol1, header = false)
writedlm("Results_PairBased/PER_depol1.dat", PER_depol1, header = false)
writedlm("Results_PairBased/PER_hyperpol1.dat", PER_hyperpol1, header = false)
writedlm("Results_PairBased/DC_depol1.dat", DC_depol1, header = false)
writedlm("Results_PairBased/DC_hyperpol1.dat", DC_hyperpol1, header = false)
writedlm("Results_PairBased/IBF_depol1.dat", IBF_depol1, header = false)
writedlm("Results_PairBased/IBF_hyperpol1.dat", IBF_hyperpol1, header = false)
writedlm("Results_PairBased/freq_depol1.dat", freq_depol_vec1, header = false)
writedlm("Results_PairBased/freq_hyperpol1.dat", freq_hyperpol_vec1, header = false)


writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/Vconnect_spk.dat", Vconnect, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/w.dat", w_, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/gCaTvec_E.dat", gCaTvec_E, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/gCaTvec_C.dat", gCaTvec_C, header = false)
writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/gCaTvec_I.dat", gCaTvec_I, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/pot_mat.dat", pot_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/dep_mat.dat", dep_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/nul_mat.dat", nul_mat, header = false)
#writedlm("/Users/kathleen/Documents/PhD/2022-reset/NetBIG/Results_PairBased/tot.dat", tot, header = false)
