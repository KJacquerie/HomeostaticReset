...
# Include model
include("model_Dep_DD_rel_checkFD_SJO.jl")
...
expm="DD_rel"
Omega_p = 0.5*(gamma_p-gamma_d)/tau_w
Omega_d = -0.5*gamma_d/tau_w
Omega_0 = 0.
#=
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model11/results_tonic/checkFSJO_%s_wpos.dat", expm), wdelta_pos, header=false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model11/results_tonic/checkFSJO_%s_wneg.dat", expm), wdelta_neg, header=false)
