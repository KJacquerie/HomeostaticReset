...
const T1 = convert(Int64, 100 / dt)
const T2 = convert(Int64, 3000 / dt)
const T1 = convert(Int64, 2000 / dt)
const T2 = convert(Int64, 3000 / dt)
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/trace/%s/w%d/Vconnect.dat",strength, w_init*10), Vconnect, header = false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/trace/%s/w%d/w.dat",strength, w_init*10), w, header = false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/trace/%s/w%d/cpre.dat",strength, w_init*10), cpre, header = false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/trace/%s/w%d/cpost.dat",strength, w_init*10), cpost, header = false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/trace/%s/w%d/ca.dat",strength, w_init*10), c_var, header = false)
