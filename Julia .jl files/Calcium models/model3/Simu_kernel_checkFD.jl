...
# Include model
include("model_kernel_checkFD.jl")
...
## Param GRAUPNER 2016 linear


## Param GRAUPNER 2016

const expm="kernel_DP"
...
=#
#=
const expm="kernel_Ddown"


const tau_Ca = 22.27212 #[ms]
const C_Pre  = 0.84410
const C_Post = 1.62138*0.85
const D_pre  = 9.53709 #[ms]
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-NMOD/GB_kernel/results/checkF%d_%s_wpos.dat",count_fMIN, expm), wdelta_pos, header=false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-NMOD/GB_kernel/results/checkF%d_%s_wneg.dat",count_fMIN, expm), wdelta_neg, header=false)
