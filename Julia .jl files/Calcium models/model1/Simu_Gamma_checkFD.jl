...
# Include model
include("model_Gamma_checkFD.jl")
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model1/results_tonic/checkF%d_%s_wpos.dat",count_fMIN, expm), wdelta_pos, header=false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model1/results_tonic/checkF%d_%s_wneg.dat",count_fMIN, expm), wdelta_neg, header=false)
