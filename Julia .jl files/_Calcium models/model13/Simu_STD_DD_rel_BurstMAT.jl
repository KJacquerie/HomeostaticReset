...
# Include model
include("model_STD_DD_rel_BurstMAT.jl")
...
function simu_wI()
    for j=1:1:length(w_init_vec)
        ...
        for p=1:1:length(IstepI_vec)
            ...
            cd(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model13/results_sleep/weak/w%d/%d/",w_init_vec[j]*10,p))
