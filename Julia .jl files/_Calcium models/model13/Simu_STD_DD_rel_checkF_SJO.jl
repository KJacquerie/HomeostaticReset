...
# Include model
include("model_STD_DD_rel_checkF_SJO.jl")
...
## Param Deperrois 2020 STD
const expm="STD_DD_rel_SJO"
...
const Omega_p = 0.5*(gamma_p-gamma_d)#/(gamma_p+gamma_d)
const Omega_d = -0.5*gamma_d#0.
const Omega_0 = 0.
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model13/results_tonic/checkF%d_%s_wpos.dat",count_fMIN, expm), wdelta_pos, header=false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model13/results_tonic/checkF%d_%s_wneg.dat",count_fMIN, expm), wdelta_neg, header=false)
