...
# Include model
include("model_Control_checkFD_SJO.jl")
...
const SJO_pos = [0.96, 1.14, 1.29, 1.53, 1.56]
const SJO_neg = [0.71, 0.59, 0.66, 1.56, 1.75]
wfinal_pos = zeros(length(frequencies))
wfinal_neg = zeros(length(frequencies))
println("delay=", delay_pre)
# RUN MODEL
...
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/results_tonic/checkFSJO_%s_wpos.dat", expm), wdelta_pos, header=false)
writedlm(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/model2/results_tonic/checkFSJO_%s_wneg.dat", expm), wdelta_neg, header=false)
...
plot!([0.1; 10; 20; 40; 50], SJO_pos,marker="o",color="red")
plot!([0.1; 10; 20; 40; 50], SJO_neg,marker="o", color="blue")
