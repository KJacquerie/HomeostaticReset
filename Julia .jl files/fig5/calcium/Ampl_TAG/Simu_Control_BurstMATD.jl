...
# Omega_p becomes a function of the weight
...
function simu_wI()
        for j=1:1:length(w_init_vec)
            ...
            for p=1:1:length(IstepI_vec)
                ...
                cd(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/NMOD-SP/calcium/Ampl_TAG/results_%s/w%d/%d/",expm,w_init_vec[j]*10,p))
