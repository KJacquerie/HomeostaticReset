...
# Include model
include("model_Control_BurstMATD.jl")
...
const IstepI_vec = -1.7-IappI:0.1:-1.0-IappI
...
function simu_wI()
        for j=1:1:length(w_init_vec)
            ...
            for p=1:1:length(IstepI_vec)
                ...
                cd(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/NMOD-SP/calcium/tau/results_%s/w%d/%d/",expm,w_init_vec[j]*10,p))
