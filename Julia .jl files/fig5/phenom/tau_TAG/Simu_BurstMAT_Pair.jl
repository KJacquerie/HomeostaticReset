...
const Am = 0.0053
const Ap = 0.0096
#const tau_m = 33.7*1.5
#const tau_p = 16.8*0.5
SB = 1
...
function simu_wI()
        ...
        for j=1:1:length(w_init_vec)
            ...
            for p=1:1:length(IstepI_vec)
                ...
                cd(@sprintf("/Users/kathleen/Documents/PhD/2022-reset/NMOD-SP/phenom/tau_TAG/results_%s/w%d/%d/",expm,w_init_vec[j]*10,p))
