...
function dx(x::Float64, V::Float64, Vprev::Float64, tau_p::Float64)
  (dt)*-x/tau_p + 1*(Vprev<= 0 && V >0)
end

function dy(y::Float64, V::Float64, Vprev::Float64, tau_m::Float64)
