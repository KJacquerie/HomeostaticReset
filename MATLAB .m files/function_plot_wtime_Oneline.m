function function_plot_wtime_Oneline(folder, expm, name_save, strength, num_Iapp)
    close all 
    w0 = 0:0.1:1; 
...
color_blue{11}=[  56,  82, 121]; 
    ...
    print(sprintf('/Users/kathleen/Documents/PhD/2022-reset/Fig4/%s',name_save),'-depsc')
