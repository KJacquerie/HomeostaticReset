...
* *Fig1A_plot_LFP.m*
Matlab code that load the data generated by the Julia code Simu_scenario_LFP.jl in order to plot the membrane potential and the LFP signal in a network. 
